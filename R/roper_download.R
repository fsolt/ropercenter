...
#'
#' \code{roper_download} provides a programmatic and reproducible means to download datasets from the Roper Center 
#'
...
icpsr_download <- function(file_id, 
  ...
  quietly(gesis::setup_gesis(download_dir = download_dir,
                             file_mime = "application/zip; application/octet-stream; application/pdf"))
